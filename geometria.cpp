...
void crea_toro1(Mesh* mesh, vec4 colore)
{
	int Stacks = 200;  //numero di suddivisioni sull'asse x
	int Slices = 200;  // numero di suddivisioni sull'asse y
	float R = 1.0, r = 0.00005;
	float s, t;
...
void crea_cono(Mesh* mesh, vec4 colore)
{
	...
	mesh->ancora_obj = (vec4(1.0, 1.0, 0.0, 1.0));
	// Calc The Index Positions
	for (int i = 0; i < Slices * Stacks + Slices; ++i) {
...
void crea_cilindro(Mesh* mesh, vec4 colore)
{
	...
	mesh->ancora_obj = (vec4(0.5, 0.5, 0.5, 1.0));
	// Calc The Index Positions
	for (int i = 0; i < Slices * Stacks + Slices; ++i) {
